...
namespace StudentDbWithIO
{
    ...
    {
        PretendDatabase studentDb = new PretendDatabase();
        Communication speakWithUser = new Communication();
        Document internalIo = new Document();
        Validation validateQuery = new Validation();
        ...
        public void Driver()
        {
            ...
            {
                repeatTheQuery = false;
                // list students, foods and hometown
                internalIo.ListAllStudents();
